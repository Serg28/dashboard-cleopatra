        ...
        <header class="fixed top-0 left-0 right-0 h-16 bg-card border-b border-border z-50 flex items-center">
            ...
            <div class="flex-1 h-full flex items-center px-4 lg:px-5">
                ...
                <div class="hidden md:flex items-center gap-6 ml-2">
                    ...
                    <a href="#" class="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Components</a>
                    <a href="#" class="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Alerts</a>
                </div>
